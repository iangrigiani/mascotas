...
class PublicacionFilter(django_filters.FilterSet):
    ...
    fecha_concretada_min = django_filters.DateFilter(lookup_type='gte', name="fecha_concretada")
    fecha_concretada_max = django_filters.DateFilter(lookup_type='lte', name="fecha_concretada")
    ...
    class Meta:
        model = Publicacion
        fields = ['usuario', 'aviso', 'mascota', 'en_transito', 'fecha_publicacion_min', 'fecha_publicacion_max',
                  'fecha_concretada_min', 'fecha_concretada_max', 'estado', 'sexo', 'edad_min', 'edad_max', 'tamanio', 
                  'compatible_chicos', 'estado_usuario']
